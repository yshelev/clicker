...
screen_settings = pygame.Surface((SCREEN_WIDTH, SCREEN_HEIGHT))
screen_active_upgrades_loop = pygame.Surface((SCREEN_WIDTH, SCREEN_HEIGHT))
screen_passive_upgrades_loop = pygame.Surface((SCREEN_WIDTH, SCREEN_HEIGHT))
